<?php exit;?>001478789156bb07db188ace0e09aa2d3de6619674aas:3884:"a:2:{s:8:"template";s:3820:"<!doctype html>
<html class="no-js">
<head>
    <meta charset="utf-8">
        ...
        <div class="am-u-sm-9 page-right">
            ...
            <div class="list">
               <ul>
                   ...
                   <li><a href="<?php echo $vo["aurl"];?>" title="<?php echo $vo["title"];?>"><i class="am-icon-angle-right am-icon-fw"></i><?php echo $vo["title"];?></a><span class="date"><?php echo date('m-d',$vo["time"]);?></span></li>
                   <?php } ?>
               </ul>
            </div>
...
";s:12:"compile_time";i:1447253156;}";