<?php exit;?>001466146174bc8ead2ade430a46daf6388b1270f38cs:3801:"a:2:{s:8:"template";s:3737:"<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <div class="dux-head clearfix">
        <div class="dux-logo">
            <a href="http://www.duxcms.com" target="_blank">
                <img src="/duxcms/public/lib/images/logo.png" alt="duxcms后台管理系统" />
            </a>
        ...
        <div class="dux-nav">
            ...
            <ul class="nav  nav-navicon nav-menu nav-inline admin-nav nav-tool">
               <li> <a href="/duxcms/" target="_blank" class="icon-home"></a></li>
...
</html>";s:12:"compile_time";i:1434610174;}";